namespace GymApp.Services.Data
{
    ...
    public class CartService : ICartService
    {
        ...
        public CartViewModel CreateNewCartViewModel(List<ProductViewModel> modelProducts, decimal sum)
        {
        ...
        public async Task<bool> IsInCartHasProductByNameAsync(string productName)
        {
